...
tiffFields[] = {
	...
	{ TIFFTAG_OPIIMAGEID, -1, -1, TIFF_ASCII, 0, TIFF_SETGET_ASCII, TIFF_SETGET_UNDEFINED, FIELD_CUSTOM, 1, 0, "OPI_Image_ID", NULL },
	/* begin SGI tags */
	...
	/* end TIFF/FX tags */
	/* begin pseudo tags */
		{ TIFFTAG_X_POS, 1, 1, TIFF_FLOAT, 0, TIFF_SETGET_FLOAT, TIFF_SETGET_UNDEFINED, FIELD_CUSTOM, 1, 0, "X_Position", NULL },
		{ TIFFTAG_Y_POS, 1, 1, TIFF_FLOAT, 0, TIFF_SETGET_FLOAT, TIFF_SETGET_UNDEFINED, FIELD_CUSTOM, 1, 0, "Y_Position", NULL },
		{ TIFFTAG_Z_POS, 1, 1, TIFF_FLOAT, 0, TIFF_SETGET_FLOAT, TIFF_SETGET_UNDEFINED, FIELD_CUSTOM, 1, 0, "Z_Position", NULL },
